...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 120 120" {...props}>
      <circle cx="60" cy="60" r="60" fill="url(#paint0_linear_logoround)" />
      <path
        id="XMLID_62_"
      ...
      <path
        ...
        fill="#FDE283"
      />
      <circle id="XMLID_35_" cx="100.38" cy="76.72" r="7.4" fill="#C47930" />
      <path
        id="XMLID_34_"
        d="M96.2,48.72l0.15-0.02c0.06,0.45,0.1,0.91,0.1,1.37c0,5.37-4.35,9.72-9.72,9.72 c-4.89,0-8.95-3.62-9.62-8.34l0.34-0.05L96.2,48.72z"
        fill="#C47930"
      />
      <path
        id="XMLID_33_"
        d="M96.35,48.7l-19.24,2.75c-0.05-0.32-0.02-0.6-0.02-0.94c0-4.21,4.55-7.72,9.83-7.72 C91.44,42.8,95.38,45.31,96.35,48.7z"
        fill="#E5AB4C"
      />
      <ellipse id="XMLID_32_" cx="79.45" cy="30.61" rx="4.81" ry="3.55" fill="#E5AB4C" />
      <circle id="XMLID_31_" cx="75.14" cy="87.06" r="4.56" fill="#C47930" />
      <circle id="XMLID_30_" cx="55.79" cy="73.47" r="11.25" fill="#C47930" />
      <ellipse id="XMLID_29_" cx="56.3" cy="40.8" rx="7.2" ry="4.81" fill="#E5AB4C" />
      <circle id="XMLID_28_" cx="37.25" cy="95.31" r="6.38" fill="#C47930" />
      <path
        id="XMLID_27_"
        d="M40.11,56.76l0.04-0.01c0.29,0.58,0.44,1.23,0.44,1.91c0,2.49-2.13,4.51-4.75,4.51 c-2.63,0-4.75-2.02-4.75-4.51c0-0.21,0.01-0.42,0.04-0.62L40.11,56.76z"
        fill="#C47930"
      />
      <path
        id="XMLID_26_"
        d="M40.11,56.76l-8.97,1.28h-0.01c0.09-1.76,2.17-3.16,4.72-3.16 C37.74,54.88,39.36,55.65,40.11,56.76z"
        fill="#E5AB4C"
      />
      <ellipse id="XMLID_25_" cx="24.41" cy="77.99" rx="3.42" ry="3.42" fill="#C47930" />
      <defs>
        <linearGradient id="paint0_linear_logoround" x1="60" y1="0" x2="60" y2="120" gradientUnits="userSpaceOnUse">
